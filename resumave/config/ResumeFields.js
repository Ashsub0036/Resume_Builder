export default {
    contact: {
        ...
        name: 'Contact',
        fields: [
            { name: 'name', label: 'Full Name', placeholder: 'Ashwini', required: true },
            { name: 'title', label: 'Your Job Title', placeholder: 'Web Dev' },
            { name: 'email', label: 'Email', type: 'email', placeholder: 'ashwini@123.com' },
            { name: 'phone', label: 'Phone', type: 'tel', placeholder: '+1234567890' },
            { name: 'address', label: 'Address', placeholder: '123 Street, City, Country' },
            { name: 'linkedin', label: 'Linked', placeholder: 'linkedin.com/in/ashwini' },
            { name: 'github', label: 'Github', placeholder: 'github.com/ashwini' },
            { name: 'blogs', label: 'Blogs', placeholder: 'github.com/ashwini' },
            { name: 'twitter', label: 'Twitter', placeholder: 'github.com/ashwini' },
            { name: 'portfolio', label: 'Portfolio', placeholder: 'ashwini.com' },
        ],
    },
    summary: {
        name: 'Summary',
